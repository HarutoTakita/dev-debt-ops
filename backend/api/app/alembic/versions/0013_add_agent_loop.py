"""add agent_pipelines / agent_activities / narrative_steps / narrative_evidence (issue 036)
...
def upgrade() -> None:
    """Create the Twin-Agent loop tables (issue 036). project_id is indexed (no FK)."""
    op.create_table(
        "agent_pipelines",
