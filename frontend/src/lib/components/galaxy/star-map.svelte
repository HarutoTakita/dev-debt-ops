...
<!-- 狭幅では横スクロール。内側は正方形にしてノード(HTML %)と依存線(SVG viewBox)が共有座標系で一緒にリフローする。 -->
<div class="h-full min-h-[24rem] overflow-auto rounded-lg border bg-card">
  <div class="relative aspect-square min-w-[34rem]">
    <!-- 薄い方眼グリッド（グラフキャンバスの目安） -->
    <div
