<script lang="ts" module>
  ...
  export const sheetVariants = tv({
    base: "bg-background fixed z-50 flex flex-col gap-4 shadow-lg transition ease-in-out data-open:animate-in data-open:duration-300 data-closed:animate-out data-closed:duration-200",
    variants: {
      side: {
        top: "data-open:slide-in-from-top data-closed:slide-out-to-top inset-x-0 top-0 h-auto border-b",
        bottom: "data-open:slide-in-from-bottom data-closed:slide-out-to-bottom inset-x-0 bottom-0 h-auto border-t",
